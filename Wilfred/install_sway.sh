...
# Config
cp -r /home/jordan/GitRepo/LinuxSetup/Wilfred/config/* /home/jordan/.config/
...
flatpak --user install -y flathub org.libreoffice.LibreOffice com.sublimetext.three org.kde.okular
